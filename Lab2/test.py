...
class TestKDTree(unittest.TestCase):
    def setUp(self):
        ...
        self.brute_force = FuerzaBruta(self.points)
...
def visualize_range_search(points, target):
...
def visualize_nearest_neighbor(points, target):
    kdtree = KDTree(points)
...
if __name__ == '__main__':
    ...
    print("\nGenerando mapa de 10,000 puntos compartido (tardará un momento)...")
    shared_points = generate_points(10000, 2)
    shared_target = (5000, 5000)
    
    print("\nAbriendo ventana para visualizar el Range Search...")
    visualize_range_search(shared_points, shared_target)
    
    print("\nAbriendo ventana para visualizar el Nearest Neighbor...")
    visualize_nearest_neighbor(shared_points, shared_target)
