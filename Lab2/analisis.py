...
def run_benchmark():
    ...
    sizes = [10, 50, 100, 200, 500, 1000, 2000, 5000, 10000, 20000]
    kd_times = []
    bf_times = []
    ...
    for n in sizes:
        ...
        # Construcción de estructuras (el problema no pide bench de creación, sino de búsqueda)
    ...
    # Marcador decorativo en el punto de cruce
    if crossover_point:
